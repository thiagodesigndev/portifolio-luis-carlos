        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
              <p>
                Luis Carlos percebeu uma frustração muito comum no mercado: pequenos e médios empresários investiam valores altos em sites que pareciam bonitos, mas que não apareciam nas buscas do Google, demoravam para carregar no celular e não traziam clientes de verdade.
              </p>
              <p>
